...
import futuroscope.pageobjects.LandingPage;
...
public class BaseTest {
    ...
    public WebDriver initializeDriver() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//main//java//futuroscope//resources//GlobalData.properties");
        prop.load(fis);
